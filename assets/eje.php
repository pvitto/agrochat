...
<div id="area" style="width: 100%; height: 97vh; margin: 10px -20px 0px 10px;">
    <div style="height: 100%; width: 54%; float: left;  margin: 0px 10px 2px 2px;">
    ...
    <div style="height: 100%; width: 44%; float: left; overflow: hidden; border: 2px; border-color: orange; border-style: solid; border-radius: 25px;">
        <table id="tabla">
            <tr id="header">
                <td style="width: 20%;"># REMISIÓN</td>
                <td style="width: 57%;">CLIENTE</td>
                <td style="width: 23%;">ESTADO</td>
            </tr>
        </table>
    </div>
</div>
