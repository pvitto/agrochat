    ...
    function recargarStore(filtrarPorRemision = false) {
        ...
        storeGuias.load({
            callback: function (records, operation, success) {
                if (filtrarPorRemision && (!records || records.length === 0)) {
                    Ext.Msg.alert('Sin resultados', 'No se encontraron guías despachadas para esa remisión.'); // si filtramos por remision y no se encontraron registros, mostramos alerta
                }
            }
        });
    }
